...
void Window::draw(Control^ parent) {
	pictureBox->Parent = parent;
	pictureBox->Size = System::Drawing::Size(186, 16);
	pictureBox->Image = Image::FromFile("window.png");
}

System::Void Window::pictureBox_MouseMove(System::Object^ sender, System::Windows::Forms::MouseEventArgs^ e) {
	if (mousePpressed) {
